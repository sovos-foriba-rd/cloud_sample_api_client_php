...
function FaturaGonder($aliciVkn, $tarih){
    ...
    $identifier="";
    if(isset($_SESSION["vknTckn"]))
        $identifier = $_SESSION["vknTckn"];
    ...
    $invoice_AccountSupplierParty_Party_Identifi->ID = ['val'=> $identifier, 'attrs' => ['schemeID="VKN"']];
    ...
    $invoice_AccountCustomerParty_Party_Identifi->ID = ['val'=> $identifier, 'attrs' => ['schemeID="VKN"']];
